...
FORT_DLL_SPEC void FORT_CALL mpi_comm_create_errhandler_(MPI_Comm_errhandler_function comm_errhandler_fn, MPI_Fint *errhandler, MPI_Fint *ierr) {
    if (MPIR_F_NeedInit) {mpirinitf_(); MPIR_F_NeedInit = 0;}
    
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_Comm_create_errhandler(comm_errhandler_fn, (MPI_Errhandler *) errhandler);
    
#else  /* ! HAVE_FINT_IS_INT */
    int errhandler_i;
    *ierr = MPI_Comm_create_errhandler(comm_errhandler_fn, &errhandler_i);
    if (!*ierr) {
        MPII_Errhandler_set_fc(errhandler_i);
...
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_File_create_errhandler(file_errhandler_fn, (MPI_Errhandler *) errhandler);
    
#else  /* ! HAVE_FINT_IS_INT */
    int errhandler_i;
    *ierr = MPI_File_create_errhandler(file_errhandler_fn, &errhandler_i);
    if (!*ierr) {
        MPII_Errhandler_set_fc(errhandler_i);
        *errhandler = (MPI_Fint) errhandler_i;
    }
...
FORT_DLL_SPEC void FORT_CALL mpi_session_create_errhandler_(MPI_Session_errhandler_function session_errhandler_fn, MPI_Fint *errhandler, MPI_Fint *ierr) {
    if (MPIR_F_NeedInit) {mpirinitf_(); MPIR_F_NeedInit = 0;}
    
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_Session_create_errhandler(session_errhandler_fn, (MPI_Errhandler *) errhandler);
    
#else  /* ! HAVE_FINT_IS_INT */
    int errhandler_i;
    *ierr = MPI_Session_create_errhandler(session_errhandler_fn, &errhandler_i);
    if (!*ierr) {
        MPII_Errhandler_set_fc(errhandler_i);
        *errhandler = (MPI_Fint) errhandler_i;
    }
...
FORT_DLL_SPEC void FORT_CALL mpi_win_create_errhandler_(MPI_Win_errhandler_function win_errhandler_fn, MPI_Fint *errhandler, MPI_Fint *ierr) {
    if (MPIR_F_NeedInit) {mpirinitf_(); MPIR_F_NeedInit = 0;}
    
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_Win_create_errhandler(win_errhandler_fn, (MPI_Errhandler *) errhandler);
    
#else  /* ! HAVE_FINT_IS_INT */
    int errhandler_i;
    *ierr = MPI_Win_create_errhandler(win_errhandler_fn, &errhandler_i);
    if (!*ierr) {
        MPII_Errhandler_set_fc(errhandler_i);
        *errhandler = (MPI_Fint) errhandler_i;
    }
...
FORT_DLL_SPEC void FORT_CALL mpi_errhandler_create_(MPI_Comm_errhandler_function comm_errhandler_fn, MPI_Fint *errhandler, MPI_Fint *ierr) {
    if (MPIR_F_NeedInit) {mpirinitf_(); MPIR_F_NeedInit = 0;}
    
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_Errhandler_create(comm_errhandler_fn, (MPI_Errhandler *) errhandler);
    
#else  /* ! HAVE_FINT_IS_INT */
    MPI_Errhandler errhandler_i;
    *ierr = MPI_Errhandler_create(comm_errhandler_fn, &errhandler_i);
    *errhandler = (MPI_Fint) errhandler_i;
#endif
}
...
FORT_DLL_SPEC void FORT_CALL mpi_op_create_(MPI_User_function user_fn, MPI_Fint *commute, MPI_Fint *op, MPI_Fint *ierr) {
    if (MPIR_F_NeedInit) {mpirinitf_(); MPIR_F_NeedInit = 0;}
    
#ifdef HAVE_FINT_IS_INT
    *ierr = MPI_Op_create(user_fn, *commute, (MPI_Op *) op);
    
#else  /* ! HAVE_FINT_IS_INT */
    int op_i;
    *ierr = MPI_Op_create(user_fn, *commute, &op_i);
    if (!*ierr) {
        MPII_Op_set_fc(op_i);
        *op = (MPI_Fint) op_i;
    }
