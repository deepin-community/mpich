...
!     See COPYRIGHT in top-level directory
        ...
        INTERFACE MPI_SCAN_INIT
           MODULE PROCEDURE MPI_SCAN_INIT_T
        ...
        INTERFACE MPI_REDUCE_SCATTER_BLOCK_INIT
           MODULE PROCEDURE MPI_REDUCE_SCATTER_BLOCK_INIT_T
        ...
        INTERFACE MPI_NEIGHBOR_ALLTOALL_INIT
           MODULE PROCEDURE MPI_NEIGHBOR_ALLTOALL_INIT_T
        ...
        INTERFACE MPI_EXSCAN_INIT
           MODULE PROCEDURE MPI_EXSCAN_INIT_T
        ...
        INTERFACE MPI_SCATTER_INIT
           MODULE PROCEDURE MPI_SCATTER_INIT_T
        ...
        INTERFACE MPI_ISENDRECV
           MODULE PROCEDURE MPI_ISENDRECV_T
        ...
        INTERFACE MPI_GATHER_INIT
           MODULE PROCEDURE MPI_GATHER_INIT_T
        ...
        INTERFACE MPI_NEIGHBOR_ALLTOALLV_INIT
           MODULE PROCEDURE MPI_NEIGHBOR_ALLTOALLV_INIT_T
        ...
        INTERFACE MPI_ALLTOALLW_INIT
           MODULE PROCEDURE MPI_ALLTOALLW_INIT_T
        ...
        INTERFACE MPI_ALLTOALLV_INIT
           MODULE PROCEDURE MPI_ALLTOALLV_INIT_T
        ...
        INTERFACE MPI_PSEND_INIT
           MODULE PROCEDURE MPI_PSEND_INIT_T
        ...
        INTERFACE MPI_SCATTERV_INIT
           MODULE PROCEDURE MPI_SCATTERV_INIT_T
        ...
        INTERFACE MPI_NEIGHBOR_ALLTOALLW_INIT
           MODULE PROCEDURE MPI_NEIGHBOR_ALLTOALLW_INIT_T
        ...
        INTERFACE MPI_ALLTOALL_INIT
           MODULE PROCEDURE MPI_ALLTOALL_INIT_T
        ...
        INTERFACE MPI_PRECV_INIT
           MODULE PROCEDURE MPI_PRECV_INIT_T
        ...
        INTERFACE MPI_REDUCE_SCATTER_INIT
           MODULE PROCEDURE MPI_REDUCE_SCATTER_INIT_T
        ...
        INTERFACE MPI_ALLGATHER_INIT
           MODULE PROCEDURE MPI_ALLGATHER_INIT_T
        ...
        INTERFACE MPI_ALLGATHERV_INIT
           MODULE PROCEDURE MPI_ALLGATHERV_INIT_T
        ...
        INTERFACE MPI_NEIGHBOR_ALLGATHER_INIT
           MODULE PROCEDURE MPI_NEIGHBOR_ALLGATHER_INIT_T
        ...
        INTERFACE MPI_ISENDRECV_REPLACE
           MODULE PROCEDURE MPI_ISENDRECV_REPLACE_T
        ...
        INTERFACE MPI_BCAST_INIT
           MODULE PROCEDURE MPI_BCAST_INIT_T
        ...
        INTERFACE MPI_REDUCE_INIT
           MODULE PROCEDURE MPI_REDUCE_INIT_T
        ...
        INTERFACE MPI_ALLREDUCE_INIT
           MODULE PROCEDURE MPI_ALLREDUCE_INIT_T
      ...
      SUBROUTINE MPI_SCAN_INIT_T(sendbuf,recvbuf,count,datatype,op,comm,info,&
                  request,ierror)
        <type> sendbuf<dims>
        <type1> recvbuf<dims1>
        INTEGER count
        ...
        CALL MPI_SCAN_INIT(sendbuf,recvbuf,count,datatype,op,comm,info,&
                    request,ierror)
      END SUBROUTINE MPI_SCAN_INIT_T
      ...
      SUBROUTINE MPI_REDUCE_SCATTER_BLOCK_INIT_T(sendbuf,recvbuf,recvcount,&
        ...
        CALL MPI_REDUCE_SCATTER_BLOCK_INIT(sendbuf,recvbuf,recvcount,&
                    datatype,op,comm,info,request,ierror)
      END SUBROUTINE MPI_REDUCE_SCATTER_BLOCK_INIT_T
      ...
      SUBROUTINE MPI_NEIGHBOR_ALLTOALL_INIT_T(sendbuf,sendcount,sendtype,&
                  recvbuf,recvcount,recvtype,comm,info,request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        <type1> recvbuf<dims1>
        ...
        CALL MPI_NEIGHBOR_ALLTOALL_INIT(sendbuf,sendcount,sendtype,&
                    recvbuf,recvcount,recvtype,comm,info,request,ierror)
      END SUBROUTINE MPI_NEIGHBOR_ALLTOALL_INIT_T
      ...
      SUBROUTINE MPI_EXSCAN_INIT_T(sendbuf,recvbuf,count,datatype,op,comm,info,&
                  request,ierror)
        <type> sendbuf<dims>
        <type1> recvbuf<dims1>
        INTEGER count
        ...
        CALL MPI_EXSCAN_INIT(sendbuf,recvbuf,count,datatype,op,comm,info,&
                    request,ierror)
      END SUBROUTINE MPI_EXSCAN_INIT_T
      ...
      SUBROUTINE MPI_SCATTER_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
        ...
        CALL MPI_SCATTER_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcount,recvtype,root,comm,info,request,ierror)
      END SUBROUTINE MPI_SCATTER_INIT_T
      ...
      SUBROUTINE MPI_ISENDRECV_T(sendbuf,sendcount,sendtype,dest,sendtag,&
                  recvbuf,recvcount,recvtype,source,recvtag,comm,request,&
                  ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        ...
        CALL MPI_ISENDRECV(sendbuf,sendcount,sendtype,dest,sendtag,&
                    recvbuf,recvcount,recvtype,source,recvtag,comm,request,&
                    ierror)
      END SUBROUTINE MPI_ISENDRECV_T
      ...
      SUBROUTINE MPI_GATHER_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
                  recvcount,recvtype,root,comm,info,request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        ...
        CALL MPI_GATHER_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcount,recvtype,root,comm,info,request,ierror)
      END SUBROUTINE MPI_GATHER_INIT_T
      ...
      SUBROUTINE MPI_NEIGHBOR_ALLTOALLV_INIT_T(sendbuf,sendcounts,sdispls,&
                  sendtype,recvbuf,recvcounts,rdispls,recvtype,comm,info,&
                  request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcounts(*)
        INTEGER sdispls(*)
        ...
        CALL MPI_NEIGHBOR_ALLTOALLV_INIT(sendbuf,sendcounts,sdispls,&
                    sendtype,recvbuf,recvcounts,rdispls,recvtype,comm,info,&
                    request,ierror)
      END SUBROUTINE MPI_NEIGHBOR_ALLTOALLV_INIT_T
      ...
      SUBROUTINE MPI_ALLTOALLW_INIT_T(sendbuf,sendcounts,sdispls,sendtypes,&
        ...
        CALL MPI_ALLTOALLW_INIT(sendbuf,sendcounts,sdispls,sendtypes,&
                    recvbuf,recvcounts,rdispls,recvtypes,comm,info,request,&
                    ierror)
      END SUBROUTINE MPI_ALLTOALLW_INIT_T
      ...
      SUBROUTINE MPI_ALLTOALLV_INIT_T(sendbuf,sendcounts,sdispls,sendtype,&
        ...
        CALL MPI_ALLTOALLV_INIT(sendbuf,sendcounts,sdispls,sendtype,&
                    recvbuf,recvcounts,rdispls,recvtype,comm,info,request,&
                    ierror)
      END SUBROUTINE MPI_ALLTOALLV_INIT_T
      ...
      SUBROUTINE MPI_PSEND_INIT_T(buf,partitions,count,datatype,dest,tag,comm,&
                  info,request,ierror)
        <type> buf<dims>
        INTEGER partitions
        ...
        CALL MPI_PSEND_INIT(buf,partitions,count,datatype,dest,tag,comm,&
                    info,request,ierror)
      END SUBROUTINE MPI_PSEND_INIT_T
      ...
      SUBROUTINE MPI_SCATTERV_INIT_T(sendbuf,sendcounts,displs,sendtype,&
        ...
        CALL MPI_SCATTERV_INIT(sendbuf,sendcounts,displs,sendtype,&
                    recvbuf,recvcount,recvtype,root,comm,info,request,ierror)
      END SUBROUTINE MPI_SCATTERV_INIT_T
      ...
      SUBROUTINE MPI_NEIGHBOR_ALLTOALLW_INIT_T(sendbuf,sendcounts,sdispls,&
                  sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm,info,&
                  request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcounts(*)
        INTEGER(KIND=MPI_ADDRESS_KIND) sdispls(*)
        ...
        CALL MPI_NEIGHBOR_ALLTOALLW_INIT(sendbuf,sendcounts,sdispls,&
                    sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm,info,&
                    request,ierror)
      END SUBROUTINE MPI_NEIGHBOR_ALLTOALLW_INIT_T
      ...
      SUBROUTINE MPI_ALLTOALL_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
        ...
        CALL MPI_ALLTOALL_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcount,recvtype,comm,info,request,ierror)
      END SUBROUTINE MPI_ALLTOALL_INIT_T
      ...
      SUBROUTINE MPI_PRECV_INIT_T(buf,partitions,count,datatype,dest,tag,comm,&
                  info,request,ierror)
        <type> buf<dims>
        INTEGER partitions
        INTEGER(KIND=MPI_COUNT_KIND) count
        ...
        CALL MPI_PRECV_INIT(buf,partitions,count,datatype,dest,tag,comm,&
                    info,request,ierror)
      END SUBROUTINE MPI_PRECV_INIT_T
      ...
      SUBROUTINE MPI_REDUCE_SCATTER_INIT_T(sendbuf,recvbuf,recvcounts,datatype,&
        ...
        CALL MPI_REDUCE_SCATTER_INIT(sendbuf,recvbuf,recvcounts,datatype,&
                    op,comm,info,request,ierror)
      END SUBROUTINE MPI_REDUCE_SCATTER_INIT_T
      ...
      SUBROUTINE MPI_ALLGATHER_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
                  recvcount,recvtype,comm,info,request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        ...
        CALL MPI_ALLGATHER_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcount,recvtype,comm,info,request,ierror)
      END SUBROUTINE MPI_ALLGATHER_INIT_T
      ...
      SUBROUTINE MPI_NEIGHBOR_ALLGATHERV_INIT_T(sendbuf,sendcount,sendtype,&
                  recvbuf,recvcounts,displs,recvtype,comm,info,request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        <type1> recvbuf<dims1>
        ...
        CALL MPI_NEIGHBOR_ALLGATHERV_INIT(sendbuf,sendcount,sendtype,&
                    recvbuf,recvcounts,displs,recvtype,comm,info,request,&
                    ierror)
      END SUBROUTINE MPI_NEIGHBOR_ALLGATHERV_INIT_T

      SUBROUTINE MPI_GATHERV_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
        ...
        CALL MPI_GATHERV_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcounts,displs,recvtype,root,comm,info,request,ierror)
      END SUBROUTINE MPI_GATHERV_INIT_T
      ...
      SUBROUTINE MPI_ALLGATHERV_INIT_T(sendbuf,sendcount,sendtype,recvbuf,&
        ...
        CALL MPI_ALLGATHERV_INIT(sendbuf,sendcount,sendtype,recvbuf,&
                    recvcounts,displs,recvtype,comm,info,request,ierror)
      END SUBROUTINE MPI_ALLGATHERV_INIT_T
      ...
      SUBROUTINE MPI_NEIGHBOR_ALLGATHER_INIT_T(sendbuf,sendcount,sendtype,&
                  recvbuf,recvcount,recvtype,comm,info,request,ierror)
        <type> sendbuf<dims>
        INTEGER sendcount
        INTEGER sendtype
        ...
        CALL MPI_NEIGHBOR_ALLGATHER_INIT(sendbuf,sendcount,sendtype,&
                    recvbuf,recvcount,recvtype,comm,info,request,ierror)
      END SUBROUTINE MPI_NEIGHBOR_ALLGATHER_INIT_T
      ...
      SUBROUTINE MPI_ISENDRECV_REPLACE_T(buf,count,datatype,dest,sendtag,&
        ...
        CALL MPI_ISENDRECV_REPLACE(buf,count,datatype,dest,sendtag,&
                    source,recvtag,comm,request,ierror)
      END SUBROUTINE MPI_ISENDRECV_REPLACE_T
      ...
      SUBROUTINE MPI_BCAST_INIT_T(buffer,count,datatype,root,comm,info,request,&
                  ierror)
        <type> buffer<dims>
        INTEGER count
        INTEGER datatype
        ...
        CALL MPI_BCAST_INIT(buffer,count,datatype,root,comm,info,request,&
                    ierror)
      END SUBROUTINE MPI_BCAST_INIT_T
      ...
      SUBROUTINE MPI_REDUCE_INIT_T(sendbuf,recvbuf,count,datatype,op,root,comm,&
                  info,request,ierror)
        <type> sendbuf<dims>
        <type1> recvbuf<dims1>
        INTEGER count
        ...
        CALL MPI_REDUCE_INIT(sendbuf,recvbuf,count,datatype,op,root,comm,&
                    info,request,ierror)
      END SUBROUTINE MPI_REDUCE_INIT_T
      ...
      SUBROUTINE MPI_ALLREDUCE_INIT_T(sendbuf,recvbuf,count,datatype,op,comm,&
                  info,request,ierror)
        <type> sendbuf<dims>
        <type1> recvbuf<dims1>
        INTEGER count
        ...
        CALL MPI_ALLREDUCE_INIT(sendbuf,recvbuf,count,datatype,op,comm,&
                    info,request,ierror)
      END SUBROUTINE MPI_ALLREDUCE_INIT_T
