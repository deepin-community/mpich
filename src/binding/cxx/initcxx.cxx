...
Datatype BOOL(MPI_CXX_BOOL);
Datatype COMPLEX(MPI_CXX_FLOAT_COMPLEX);
Datatype DOUBLE_COMPLEX(MPI_CXX_DOUBLE_COMPLEX);
Datatype LONG_DOUBLE_COMPLEX(MPI_CXX_LONG_DOUBLE_COMPLEX);
